...
export function NavBar() {
    ...
    function responsiveMenu() {
        if(navMenu?.classList.contains('absolute')) {
    ...
    return (
        <nav className="p-2 bg-[#0377AA] md:flex md:items-center md:justify-between">
            ...
            <ul id="nav-menu" className="md:flex md:items-center md:static w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-100 transition-all ease-in duration-500">
